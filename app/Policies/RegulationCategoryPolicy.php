...
class RegulationCategoryPolicy
{
     ...
     */
    public function restore(User $user, RegulationCategory $regulationCategory): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, RegulationCategory $regulationCategory): bool
    {
        return false;
    }
}
