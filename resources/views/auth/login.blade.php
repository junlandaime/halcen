            ...
            <a href="{{ route('login.google') }}"
               class="flex items-center justify-center w-full gap-3 border border-gray-300 rounded-md px-4 py-2
                ...
                <svg class="w-5 h-5" viewBox="0 0 533.5 544.3">
                    <path fill="#4285F4" d="M533.5 278.4c0-18.8-1.6-37-4.6-54.6H272v103.1h146.9c-6.3 33.9-25 62.7-53.3 82l86.1 66.9c50.2-46.3 79.8-114.6 79.8-197.4z"/>
                    <path fill="#34A853" d="M272 544.3c72.2 0 132.7-23.9 176.9-65.1l-86.1-66.9c-24 16.1-54.8 25.6-90.8 25.6-69.9 0-129.3-47.2-150.4-110.4l-88.5 68.5C75 482.5 167.6 544.3 272 544.3z"/>
                    <path fill="#FBBC04" d="M121.6 327.5c-10.3-30.1-10.3-62.6 0-92.7l-88.5-68.5C-13.3 240.2-13.3 304.1 33.1 359.9l88.5-32.4z"/>
                    <path fill="#EA4335" d="M272 108.4c39.3-.6 77.1 14 104.7 40.2l78.3-78.3C406.8 23.2 341.5-1.3 272 0 167.6 0 75 61.8 33.1 153l88.5 68.5C142.7 172.7 202.1 108.4 272 108.4z"/>
                </svg>
