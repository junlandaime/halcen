        ...
        <div class="max-w-6xl mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-lg p-8" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="text-gray-600 mb-6">Jalur sertifikasi mandiri untuk UMKM dengan kriteria tertentu sesuai
                        regulasi BPJPH.</p>
                    <div class="space-y-6">
                        <div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-8" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="text-gray-600 mb-6">Jalur sertifikasi standar melalui Lembaga Pemeriksa Halal (LPH) Salman
                        ITB.</p>
                    <div class="space-y-6">
                        <div>
                            <h4 class="font-semibold mb-3">Syarat dan Ketentuan:</h4>
