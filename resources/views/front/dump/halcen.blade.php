            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div class="space-y-6" data-aos="fade-left">
                    ...
                    <p class="text-gray-600">
                        Pusat Halal Salman ITB adalah lembaga yang bergerak dalam pengembangan dan penerapan sistem jaminan
                        halal di Indonesia. Didirikan dengan semangat untuk memajukan industri halal nasional, kami
                        memadukan keahlian teknis dengan pemahaman syariah yang komprehensif.
                    </p>
                    <p class="text-gray-600">
                        Sebagai bagian dari Yayasan Salman ITB, kami berkomitmen untuk memberikan layanan terbaik dalam
                        sertifikasi halal, pendidikan, dan pemberdayaan UMKM menuju ekosistem halal yang berkelanjutan.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="bg-white p-8 rounded-xl shadow-lg" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="text-gray-600">
                        Menjadi pusat unggulan dalam pengembangan dan penerapan sistem jaminan halal yang terintegrasi,
                        berbasis teknologi, dan berkelanjutan di Indonesia.
                    </p>
                </div>
