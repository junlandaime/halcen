        ...
        <div class="max-w-6xl mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                <div class="md:col-span-2 space-y-6" data-aos="fade-right">
                    ...
                    <p class="text-gray-600 text-lg">Program Kuliah Halal merupakan program pendidikan komprehensif yang
                        dirancang untuk memberikan pemahaman mendalam tentang sistem jaminan halal. Program ini mencakup
                        aspek teoritis dan praktis dalam penerapan sistem halal pada industri pangan, farmasi, dan
                        kosmetika.</p>
                    <div class="space-y-4">
