...
@section('title')
    <title>Manajemen Klien - Admin Pusat Halal Salman ITB</title>
@endsection
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400">UMKM</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Konsultasi</p>
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-4">Kontak</th>
                            <th scope="col" class="px-4 py-4">Status</th>
                            <th scope="col" class="px-4 py-4">Sertifikasi</th>
                    ...
                    <tbody>
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3">Perusahaan</td>
                            <td class="px-4 py-3">contact@msi.com</td>
                            <td class="px-4 py-3">
                                <span class="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-green-900 dark:text-green-300">
                                    Aktif
                                </span>
                            </td>
                            <td class="px-4 py-3">3 Produk</td>
                            <td class="px-4 py-3">
