...
<aside class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform"
    :class="{ '-translate-x-full': !sidebarOpen, 'translate-x-0': sidebarOpen }" @click.away="sidebarOpen = fal-se">
        ...
        <ul class="space-y-2 font-medium">
                ...
                <ul id="dropdown-content" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{ route('admin.articles.index') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Artikel</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('admin.regulations.index') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Regulasi</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.abouts.index') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Tentang
                            Kami</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.faqs.index') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">FAQ</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <a href="{{ route('admin.program-layanan.index') }}"
                    ...
                    <span class="ml-3">Program & Layanan</span>
                </a>
            </li>
