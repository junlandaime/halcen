...
<footer class="bg-white border-t">
    <div class="max-w-6xl mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                ...
                <div class="flex gap-4">
                    ...
                    @endif
                    @if ($footerLandingPage->social_linkedin)
            ...
            <div>
                ...
                <ul class="space-y-2">
                    @foreach ($footerPrograms as $program)
                        <li><a href="{{ route('program-layanan.show', $program) }}"
                                class="text-gray-600 hover:text-primary">{{ $program->nama_program }}</a></li>
                    @endforeach
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="{{ route('regulations.index') }}" class="text-gray-600 hover:text-primary">Tentang
                            Regulasi Halal</a></li>
                    <li><a href="{{ route('articles.index') }}" class="text-gray-600 hover:text-primary">Artikel
                            Kami</a></li>
                    <li><a href="{{ route('videos.index') }}" class="text-gray-600 hover:text-primary">Konten Kami</a>
                    </li>
                    <li><a href="{{ route('front.kontak') }}" class="text-gray-600 hover:text-primary">FAQ</a></li>
                </ul>
            </div>
        ...
        <div class="mt-12 pt-8 border-t text-center text-gray-600">
            <p>&copy; 2025 Pusat Halal Salman ITB. All rights reserved.</p>
        </div>
    </div>
</footer>
